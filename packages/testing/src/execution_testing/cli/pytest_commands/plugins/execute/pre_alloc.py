...
def _compute_deploy_gas_limit(
    ...
    *,
    ...
    # cap-sized regular limit and consumes only its (smaller) actual gas. Only a
    # contract whose unbuffered estimate exceeds the cap is truly undeployable
    # (the caller raises on that).
